...
public final class LessThanFunction

    extends Function

{
    public static LessThanFunction create( final FunctionContext context,
                                           final Function a,
                                           final Function b )
    {
    ...
    private static final class Resources extends NLS
    {
        ...
        static
        {
            initializeMessages( LessThanFunction.class.getName(), Resources.class );
        }
    }
