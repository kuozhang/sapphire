...
/**
 * Computes the sum of numbers in a collection. Typically, this function takes the collection as the sole
 ...
 * will use list entry's first value property for aggregation. A sum of an empty collection is 0.
 * 
