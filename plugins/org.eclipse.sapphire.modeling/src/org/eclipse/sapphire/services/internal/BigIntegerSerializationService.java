...
{
    @Override
    protected BigInteger decodeFromString( final String value )
    {
    ...
    public static final class Factory extends ServiceFactory
    {
                                   ...
                                   final Class<? extends Service> service )
        {
            ...
            return ( property != null && property.isOfType( BigInteger.class ) );
        }
        ...
        public Service create( final ServiceContext context,
                               final Class<? extends Service> service )
        {
            return new BigIntegerSerializationService();
        }
    }
