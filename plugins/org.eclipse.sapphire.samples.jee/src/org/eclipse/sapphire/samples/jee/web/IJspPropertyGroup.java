...
public interface IJspPropertyGroup extends IModelElement, IDescribableExt
{
    ...
    @Type( base = IJspInclude.class )
    @Label( standard = "preludes" )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "include-prelude", type = IJspInclude.class ) )
    ...
    ModelElementList<IJspInclude> getPreludes();
    
    // *** Codas ***
    
    @Type( base = IJspInclude.class )
    @Label( standard = "codas" )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "include-coda", type = IJspInclude.class ) )
    ...
    ModelElementList<IJspInclude> getCodas();
