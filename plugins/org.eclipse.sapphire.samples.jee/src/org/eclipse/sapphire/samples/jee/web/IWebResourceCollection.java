...
public interface IWebResourceCollection extends IModelElement
{
    ModelElementType TYPE = new ModelElementType( IWebResourceCollection.class );
    ...
    @Type( base = IHttpMethodTypeWrapper.class )
    @Label( standard = "HTTP method types" )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "http-method", type = IHttpMethodTypeWrapper.class ) )

    ListProperty PROP_HTTP_METHOD_TYPES = new ListProperty( TYPE, "HttpMethodTypes" );
    
    ModelElementList<IHttpMethodTypeWrapper> getHttpMethodTypes();
