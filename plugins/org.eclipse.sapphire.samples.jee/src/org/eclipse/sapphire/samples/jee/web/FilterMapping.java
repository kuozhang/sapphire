...
public interface FilterMapping extends IModelElement
{
    ...
    @Reference( target = Servlet.class )
    ...
    ReferenceValue<String,Servlet> getServlet();
    ...
    @Type( base = DispatcherEventWrapper.class )
    @Label( standard = "dispatcher events" )
    @CountConstraint( max = 4 )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "dispatcher", type = DispatcherEventWrapper.class ) )
    ...
    ModelElementList<DispatcherEventWrapper> getDispatcherEvents();
