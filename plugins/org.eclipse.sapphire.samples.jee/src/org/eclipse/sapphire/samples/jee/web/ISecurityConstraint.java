...
public interface ISecurityConstraint extends IModelElement
{
    ...
    @Type( base = IWebResourceCollection.class )
    @Label( standard = "web resource collections" )
    @CountConstraint( min = 1 )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "web-resource-collection", type = IWebResourceCollection.class ) )
    
    ListProperty PROP_WEB_RESOURCE_COLLECTIONS = new ListProperty( TYPE, "WebResourceCollections" );
    
    ModelElementList<IWebResourceCollection> getWebResourceCollections();
    ...
    @Type( base = ISecurityRoleRef2.class )
    ...
    ModelElementList<ISecurityRoleRef2> getRoles();
