...
public interface JspConfig extends IModelElement
{
    ModelElementType TYPE = new ModelElementType( JspConfig.class );
    
    // *** TagLibraries ***
    
    @Type( base = TagLibrary.class )
    @Label( standard = "tag libraries" )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "taglib", type = TagLibrary.class ) )
    ...
    ModelElementList<TagLibrary> getTagLibraries();
    
    // *** PropertyGroups ***
    
    @Type( base = JspPropertyGroup.class )
    @Label( standard = "property groups" )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "jsp-property-group", type = JspPropertyGroup.class ) )
    ...
    ModelElementList<JspPropertyGroup> getPropertyGroups();
