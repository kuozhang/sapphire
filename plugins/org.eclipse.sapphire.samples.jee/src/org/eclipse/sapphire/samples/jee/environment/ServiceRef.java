...
public interface ServiceRef extends EnvironmentRef, DescribableExt
{
    ModelElementType TYPE = new ModelElementType( ServiceRef.class );
    ...
    ValueProperty PROP_NAME = new ValueProperty( TYPE, EnvironmentRef.PROP_NAME );
    ...
    @Type( base = ServicePortRef.class )
    @Label( standard = "service ports" )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "port-component-ref", type = ServicePortRef.class ) )
    ...
    ModelElementList<ServicePortRef> getPorts();
    
    // *** Handlers ***
    
    @Type( base = ServiceHandler.class )
    @Label( standard = "service handlers" )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "handler", type = ServiceHandler.class ) )
    ...
    ModelElementList<ServiceHandler> getHandlers();
