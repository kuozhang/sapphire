...
public interface IMasterDetailsContentNodeFactoryRef

    extends IMasterDetailsContentNodeListEntry
    
{
    ModelElementType TYPE = new ModelElementType( IMasterDetailsContentNodeFactoryRef.class );
    ...
    IMasterDetailsContentNodeFactoryDef resolve();
