...
import org.eclipse.sapphire.ui.forms.swt.presentation.internal.WhitespaceSeparatorPresentation;
...
{
    @Override
    public WhitespaceSeparatorDef definition()
    {
        return (WhitespaceSeparatorDef) super.definition();
    }
    
    public FormComponentPresentation createPresentation( final SwtPresentation parent, final Composite composite )
    {
        return new WhitespaceSeparatorPresentation( this, parent, composite );
    }
