...
public final class HyperlinkTable
{
    ...
    public HyperlinkTable( final Table table )
    {
        ...
        final IHandler jumpCommandHandler = new AbstractHandler() 
        {
        ...
        SapphireCommands.attachJumpHandler( this.table, jumpCommandHandler );
    }
    ...
    private void handleEraseItem( final Event event ) 
    {
        ...
        {
            event.detail = event.detail & ( ~ SWT.FOREGROUND );
        }
    }
