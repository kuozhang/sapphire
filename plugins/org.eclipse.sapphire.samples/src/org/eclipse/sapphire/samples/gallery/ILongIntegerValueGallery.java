...
@GenerateXmlBinding( elementPath = "long-integer" )

public interface ILongIntegerValueGallery

    extends IModelElementForXml

{
    ModelElementType TYPE = new ModelElementType( ILongIntegerValueGallery.class );
