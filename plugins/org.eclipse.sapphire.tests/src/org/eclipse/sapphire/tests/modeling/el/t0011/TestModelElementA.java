...
public interface TestModelElementA extends IModelElement
{
    ModelElementType TYPE = new ModelElementType( TestModelElementA.class );
    ...
    ModelElementHandle<TestModelElementA> getElement1();
