...
public final class TestXmlBinding0011h extends SapphireTestCase
{
    private TestXmlBinding0011h( final String name )
    {
        super( name );
    }
    ...
    public static Test suite()
    {
        ...
        suite.setName( "TestXmlBinding0011h" );

        suite.addTest( new TestXmlBinding0011h( "test" ) );
