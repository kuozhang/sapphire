...
public interface ITestRootElement extends IModelElement
{
    ...
    @XmlListBinding( path = "children", mappings = @XmlListBinding.Mapping( element = "child", type = ITestChildElement.class ) )
    ...
    @Type( base = ITestChildElement.class )
    @ReadOnly
    @XmlListBinding( path = "children-read-only", mappings = @XmlListBinding.Mapping( element = "child", type = ITestChildElement.class ) )
    
    ListProperty PROP_CHILDREN_READ_ONLY = new ListProperty( TYPE, "ChildrenReadOnly" );
    
    ModelElementList<ITestChildElement> getChildrenReadOnly();
