...
{
    private StartsWithFunctionTests( final String name )
    {
        super( name );
    }
    ...
    public static Test suite()
    {
        ...
        suite.setName( "StartsWithFunctionTests" );

        suite.addTest( new StartsWithFunctionTests( "testStartsWithFunction" ) );
