...
public final class TestXmlBinding0011b extends SapphireTestCase
{
    private TestXmlBinding0011b( final String name )
    {
        super( name );
    }
    ...
    public static Test suite()
    {
        ...
        suite.setName( "TestXmlBinding0011b" );

        suite.addTest( new TestXmlBinding0011b( "test" ) );
