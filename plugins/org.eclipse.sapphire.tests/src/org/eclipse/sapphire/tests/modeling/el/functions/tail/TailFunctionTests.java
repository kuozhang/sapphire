...
public final class TailFunctionTests extends TestExpr
{
    ...
    public void testTailFunction()
    {
        ...
        try( FunctionResult fr = ExpressionLanguageParser.parse( "${ Value.Tail( 3 ) }" ).evaluate( context ) )
        {
        ...
        try( FunctionResult fr = ExpressionLanguageParser.parse( "${ Value.Tail( 0 ) }" ).evaluate( context ) )
        {
