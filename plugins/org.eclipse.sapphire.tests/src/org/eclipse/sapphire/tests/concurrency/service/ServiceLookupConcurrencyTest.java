...
{
    private ServiceLookupConcurrencyTest( final String name )
    {
        super( name );
    }
    ...
    public static Test suite()
    {
        ...
        suite.addTest( new ServiceLookupConcurrencyTest( "testPropertyServiceLookup" ) );
        suite.addTest( new ServiceLookupConcurrencyTest( "testElementServiceLookup" ) );
    ...
    public void testPropertyServiceLookup() throws Exception
    {
        ...
        final Thread t1 = new Thread()
        {
            ...
            public void run()
            {
                element.services( TestElement.PROP_VALUE, TestService.class );
            }
        };
        ...
        final Thread t2 = new Thread()
        {
            ...
            public void run()
            {
                for( int i = 0; i < 1000000; i++ )
                {
                    ...
                    element.refresh( TestElement.PROP_VALUE );
                }
            }
        };
